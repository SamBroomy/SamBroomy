...
- **[is-it-slop](https://github.com/SamBroomy/is-it-slop)**: Detect AI generated slop, using ML, served in Rust using ONNX & a custom TFIDF vectorizer for blazingly fast model infrence.
