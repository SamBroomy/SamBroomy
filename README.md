...
- **[p2p blockchain](https://github.com/SamBroomy/p2p-blockchain)**: Basic implementation of a blockchain that runs on a p2p network to understand and implement a blockchain from scratch.
